...
def upload(resource, path, body, notify_subscribers=False, chunksize=4 * 1024 * 1024,
    ...
    request = resource.videos().insert(part=body_keys, body=body, notifySubscribers=notify_subscribers, media_body=media)
